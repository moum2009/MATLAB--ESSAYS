...
EUinsno = matrix_irrig_no_ins(1:fin,30:34)/10^7 % the third column of this matrix is max EU without ins
EUins= matrix_irrig_ins(1:fin,35:39)/10^7 % the 4th column is max EU with ins
